...
func TestCategorize(t *testing.T) {
	tests := map[string]string{
		...
		"Asian Chop Salad Kit":        CategoryProduce,
		"Chimichurri":                 CategoryCondiments,
		"Dashi Powder":                CategorySpices,
		"Dried Apricots":              CategoryPantry,
		"Green Olives":                CategoryPantry,
		"Harissa Powder":              CategorySpices,
		"Harissa Paste":               CategoryCondiments,
		"Lobster Tails":               CategoryMeatSeafood,
		"Marinara Cup":                CategoryCondiments,
		"Mixed Greens":                CategoryProduce,
		"Nonstick Cooking Spray":      CategoryPantry,
		"Oven-Ready Tray":             CategoryOther,
		"Parsnip":                     CategoryProduce,
		"Whole Wheat Pitas":           CategoryBakery,
		"Red Sofrito":                 CategoryCondiments,
		"Tempura Batter Mix":          CategoryPantry,
		"Three-Bean Blend":            CategoryPantry,
		"Tomatillos":                  CategoryProduce,
		"Truffle Zest":                CategorySpices,
		"Wonton Strips":               CategoryPantry,
	}
