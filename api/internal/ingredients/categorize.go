...
var categoryRules = []categoryRule{
	...
	{CategoryOther, false, []string{"skewers", "wooden skewers", "parchment", "foil", "toothpicks"}},
	...
	{CategoryPantry, false, []string{"crispy fried onions", "fried onions", "tortilla chips", "chips", "breadcrumbs", "panko", "croutons", "egg noodles", "shredded coconut"}},
	{CategoryCondiments, false, []string{"hot sauce", "sriracha", "sauce", "glaze", "paste", "dressing", "vinaigrette", "vinegar", "mayonnaise", "mayo", "ketchup", "mustard", "salsa", "pico de gallo", "guacamole", "crema", "jam", "preserves", "compote", "honey", "syrup", "aioli", "chutney", "relish", "pesto", "tahini", "hummus", "gochujang", "hoisin", "ponzu", "soy", "teriyaki", "bbq", "barbecue", "worcestershire"}},
