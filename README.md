...
| 8 | Shopping providers | Walmart cart handoff, category-aware search, product links with name and size, pack coverage ✅; order-day reminders ✅; prices (typed or from order screenshots read on the iPhone), weekly cost vs meal kit, and leftovers tracking ✅; bulk packs (plan a second meal, or portion and freeze the rest) ✅; the prep plan — a guided "you just got the groceries" checklist that portions each bulk pack and freezes the rest ✅; Instacart later |
